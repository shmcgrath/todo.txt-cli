...
type Config struct {
	// $HOME, $XDG_CONFIG_HOME or any other
	// environment variable will be expanded.
	// Tilde (~) representing home will not be expanded.
	// TodoDir should be the path to your folder containing
	// TodoFile and DoneFile. TodoFile and DoneFile should
	// be just the file names. ReportFile should be the full
